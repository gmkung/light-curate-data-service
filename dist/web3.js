    ...
    constructor(contractAddress, chainId) {
        ...
        this.getLatestMetaEvidence = async () => {
            try {
                ...
                events.forEach((e, i) => {
                    console.log(`Event ${i}: ID=${e.returnValues._metaEvidenceID}, Evidence=${e.returnValues._evidence}`);
                });
                ...
                const clearingEvent = events.find((e) => {
                    console.log(`Comparing: event ID "${e.returnValues._metaEvidenceID}" (${typeof e.returnValues._metaEvidenceID}) with search ID "${latestClearingId.toString()}" (${typeof latestClearingId.toString()})`);
